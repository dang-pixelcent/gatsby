...
export const SEO = ({
    ...
    // Sử dụng useState để "đóng băng" kết quả parse từ server
    const [parsedSeoElements, setParsedSeoElements] = useState(() => {
        // Hàm khởi tạo này CHỈ CHẠY MỘT LẦN:
        // - Trên server, nó chạy và trả về kết quả parse.
        // - Trên client, React sẽ bỏ qua nó và dùng kết quả từ server.
        if (canParseSeoData) {
            return parse(seoData);
        }
        return null;
    });
